...
namespace Daisy11Functions.Helpers
{
    public static class API
    {
        ...
        public static async Task<HttpResponseData> Success(HttpResponseData input)
        {
            ...
            await input.WriteStringAsync(JsonSerializer.Serialize(new { successMessage = "Success"}, options));
            return input;
        }
